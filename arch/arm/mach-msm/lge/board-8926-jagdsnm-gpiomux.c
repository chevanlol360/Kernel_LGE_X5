...
static int gpio_reserved_pin_rev_0[] = {
	0, 1, 53, 54, 55, 60, 75, 76, 77, 78, 79, 82, 89, 90, 91, 92, 93, 94, 97, 98, 104, 107, 116, 117, 118,
...
//Need to set GPIO[005] WLC_CHG_IRQ_N
...
static struct msm_gpiomux_config msm_camera_configs[] __initdata = {
	{
		.gpio = 26, /* CAM_MCLK0 */
		.settings = {
...
/*  LGE_CHANGE_E, [NFC][garam.kim@lge.com], NFC Bring up */
	...
	// GPIO related function <<7.CAMERA>>	
	msm_gpiomux_install(msm_camera_configs, ARRAY_SIZE(msm_camera_configs));
