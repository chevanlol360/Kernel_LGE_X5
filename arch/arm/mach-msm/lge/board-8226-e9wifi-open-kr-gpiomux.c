...
static int gpio_reserved_pin_rev_0[] = {
	2, 3, 5, 12, 14, 15, 34, 36, 38, 45, 46, 49, 50, 51, 52, 53, 54, 55, 56, 58, 59, 61, 63, 64, 65, 67, 75, 76, 77, 78, 79, 80, 82, 83, 84, 85, 86, 87, 88, 89, 90, 91, 92, 93, 94, 95, 96, 97, 98, 99, 100, 101, 103, 107, 109,
...
//Need to set +GPIO[115] PROXIMITY_INT -> E series don't use Proximity Sensor
...
// GPIO[111] LCD_LDO_EN
// GPIO[024] LCD_STBY for D2L
// GPIO[025] LCD_RESX for D2L
// GPIO[104] LCD_Booster only EVBD    ==> Check 104 is declared in reverved.
// GPIO[013] PWM GP_PDM_2A only EVBD  ==> Check 13 is declared in reverved.
// GPIO[032] LCD_LED_EN               ==> Check 32 is declared at twice by FLASH_STROBE_TRIG
/*
...
//    {
//        .func = GPIOMUX_FUNC_2,			//PWM active [0] , GP_PDM_2A(GPIO13)
//        .drv = GPIOMUX_DRV_2MA,
//        .pull = GPIOMUX_PULL_NONE,
//    },
...
static struct msm_gpiomux_config msm_lcd_configs_rev_0[] __initdata = {
	{
		.gpio = 111,		//LCD_LDO_EN
		.settings = {
...
static struct msm_gpiomux_config msm_bl_configs_rev_0[] __initdata = {
	{
		.gpio = 104,		//LCD_Booster only EVBD    ==> Check 104 is declared in reverved.
		.settings = {
			[GPIOMUX_ACTIVE]    = &bl_settings[0],
			[GPIOMUX_SUSPENDED] = &bl_settings[1],
		},
	},
	{
		.gpio = 13,			//PWM GP_PDM_2A only EVBD  ==> Check 13 is declared in reverved.
		.settings = {
			[GPIOMUX_ACTIVE]    = &bl_settings[0],
			[GPIOMUX_SUSPENDED] = &bl_settings[1],
		},
	...
	{
		.gpio = 32,			//LCD_LED_EN              ==> Check 32 is declared at twice by FLASH_STROBE_TRIG
		.settings = {
			[GPIOMUX_ACTIVE]    = &bl_settings[0],
			[GPIOMUX_SUSPENDED] = &bl_settings[1],
		},
...
/* LGE_CHANGE_S, Set gpio for camera, 2014-02-07, sangwoo25.park@lge.com */
static struct msm_gpiomux_config msm_sensor_configs[] __initdata = {
	...
	{
		.gpio = 110, /* LDO2_EN / MAIN_CAM_DVDD */
		.settings = {
			[GPIOMUX_ACTIVE]    = &cam_settings[3],
			[GPIOMUX_SUSPENDED] = &cam_settings[4],
		},
...
/* LGE_CHANGE_E, Set gpio for camera, 2014-02-07, sangwoo25.park@lge.com */
