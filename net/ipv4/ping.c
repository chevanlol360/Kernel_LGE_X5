...
int ping_init_sock(struct sock *sk)
{
	...
	gid_t range[2];
//	struct group_info *group_info = get_current_groups();	// 2014.06.24 cooper.jeong@lge.com for CVE-2014-2851
//	int i, j, count = group_info->ngroups;
	...
	group_info = get_current_groups();	// 2014.06.24 cooper.jeong@lge.com for CVE-2014-2851
	...
	for (i = 0; i < group_info->nblocks; i++) {
		...
		for (j = 0; j < cp_count; j++) {
			...
			if (range[0] <= group && group <= range[1])
//				return 0;		// 2014.06.24 cooper.jeong@lge.com for CVE-2014-2851
...
//	return -EACCES;	// 2014.06.24 cooper.jeong@lge.com for CVE-2014-2851
	ret = -EACCES;

out_release_group:	// 2014.06.24 cooper.jeong@lge.com for CVE-2014-2851
