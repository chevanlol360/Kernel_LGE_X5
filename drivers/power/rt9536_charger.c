...
//	msleep(3);
	...
	{
		schedule_delayed_work(&rt9536_chg->wireless_eoc_work,
...
{
	struct rt9536_chip *rt9536_chg = container_of(work,
		struct rt9536_chip,wireless_set_offline_work.work);
	printk("[RT9536] %s \n",__func__);
...
//	i2c_set_clientdata(client, chip);
	...
	INIT_DELAYED_WORK(&chip->wireless_set_offline_work,wlc_set_offline_work);
	INIT_DELAYED_WORK(&chip->wireless_eoc_work,wlc_eoc_work);
